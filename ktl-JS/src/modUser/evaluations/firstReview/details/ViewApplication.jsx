    ...
    <div className="card w-full max-w-screen-xl gap-2">
      ...
      <PersonalDevList
        data={{
          ...
          timelineThree: data.timelineThree,
          // data.timelineThree !== "1980-12-31T00:00:00"
          //   ? new Date(data.timelineThree)
          //   : "",
          reviewDateThree: data.reviewDateThree,
