    ...
    <div className="card w-full max-w-screen-xl gap-2">
      ...
      <ObjectivesList
        data={{
          ...
          objectiveDetailsFour: list.data.objectiveDetailsFour,
          employeeCommentFour: list.data.employeeCommentFour,
          managerCommentOne: list.data.managerCommentOne,
          ratingOne: list.data.ratingOne,
          managerCommentTwo: list.data.managerCommentTwo,
          ratingTwo: list.data.ratingTwo,
          managerCommentThree: list.data.managerCommentThree,
          ratingThree: list.data.ratingThree,
          managerCommentFour: list.data.managerCommentFour,
          ratingFour: list.data.ratingFour,
        }}
      />
      <BehaviorsList
        data={{
      ...
      />
      {list.data.acceptRemarks === "" && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-5">
          <Accept id={list.data.evaluationId} />
          <Reject
            id={list.data.evaluationId}
            returnPath="/evaluation/second/review/list"
          />
        </div>
      )}
    </div>
