...
const BillDetailsEdit = () => {
  ...
  const {
    ...
    isError,
    refetch,
  } = useGetData("travelingBill", `/userMyTravelingBillDetails/details/${id}`);
  ...
  return (
    <div className="card w-full max-w-screen-xl">
      <TopHeader
        ...
        btn="Return"
        path={`/transportBill/preview/${list.data.travelId}`}
      />
      <BillDetailsForm
        defaultValues={{
        ...
        action={refetch}
        btnText="Update"
        path="/userMyTravelingBillDetails/update"
        returnPath={`/transportBill/preview/${list.data.travelId}`}
      />
    </div>
  );
};
