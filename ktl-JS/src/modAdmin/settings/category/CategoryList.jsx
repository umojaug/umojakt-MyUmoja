...
const CategoryList = () => {
  const {
    ...
    isError,
    refetch,
  } = useGetData("counselingtopic", "/adTicketCategory/list");
  ...
  return (
    <div className="card w-full max-w-screen-xl">
      <TopHeader
        ...
        btn="Save"
        path="/admin/settings/category/add"
      />
            ...
            >
              ...
              <div>
                <div className="flex justify-end space-x-2">
                  <EditButton
                    path={`/admin/settings/category/edit/${item.categoryId}`}
                  />
                  <DeleteButton
                    action={refetch}
                    path={`/adTicketCategory/delete/${item.categoryId}`}
                  />
                </div>
              </div>
            </div>
