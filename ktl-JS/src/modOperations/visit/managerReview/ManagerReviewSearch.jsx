...
import ManagerReviewList from "./ManagerReviewList";

const ManagerReviewSearch = () => {
  var date = new Date();
  ...
  return (
    <div className="card w-full max-w-screen-xl">
      ...
      {dataForm && <ManagerReviewList dataForm={dataForm} />}
    </div>
  );
};

export default ManagerReviewSearch;
