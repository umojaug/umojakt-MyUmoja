...
import LedgerListPDF from "./LedgerListPDF";

const LedgerReportsList = () => {
  const {
    data: list,
    error,
    isLoading,
    isError,
  } = useGetData("AccountLedgerListReports", "/AccountLedgerListReports");
  ...
  return (
    <div className="card w-full max-w-screen-xl">
      <div className="flex justify-between items-center border w-40 h-8 rounded">
        <PDFDownloadLink
          document={<LedgerListPDF list={list} />}
          fileName="ledger-list.pdf"
