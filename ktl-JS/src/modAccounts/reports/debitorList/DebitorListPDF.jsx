          ...
          <View style={styles.table}>
            ...
            <View style={styles.totalWrapper}>
              ...
              <View style={styles.totalOthers}>
                <Text style={styles.smallTille}>{list.data.totalCreditB}</Text>
              </View>
              <View style={styles.totalOthers}>
                <Text style={styles.smallTille}>{list.data.totalDepositB}</Text>
              </View>
              <View style={styles.totalOthers}>
                <Text style={styles.smallTille}>{list.data.totalBalanceB}</Text>
              </View>
            </View>
          </View>
        </View>
