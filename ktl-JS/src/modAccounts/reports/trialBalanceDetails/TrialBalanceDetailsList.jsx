...
import TrialBalanceDetailsListPDF from "./TrialBalanceDetailsPDF";

const TrialBalanceDetailsList = () => {
  const {
    data: list,
    error,
    isLoading,
    ...
    "AccountTrialBalanceDetailsListReports",
    "/AccountTrialBalanceDetailsListReports"
  );
  ...
  return (
    <div className="card w-full max-w-screen-xl">
      <div className="flex justify-between items-center border w-40 h-8 rounded">
        <PDFDownloadLink
          document={<TrialBalanceDetailsListPDF list={list} />}
          fileName="trialBalanceDetails-list.pdf"
      ...
      <div className="my-2">
        <div className="list-wrapper">
          <div className="md:grid grid-cols-5 list-header">
            ...
            <div className="flex justify-start">
              <span className="font-semibold break-all">Account No</span>
            </div>
            <div className="flex justify-start">
              <span className="font-semibold break-all">Sub Head</span>
            </div>
            <div className="flex justify-start">
            ...
            list.data.tableList.map((item, index) => (
              ...
              >
                ...
                <div>
                  ...
                  <span className="break-words">{item.accountNo}</span>
                </div>
                <div>
                  <span className="inline-block md:hidden font-semibold">
                    Sub Head:
                  </span>
                  <span className="break-words">{item.subHead}</span>
                </div>
                <div>
                  <span className="inline-block md:hidden font-semibold">
                    For The Period:
...
export default TrialBalanceDetailsList;
