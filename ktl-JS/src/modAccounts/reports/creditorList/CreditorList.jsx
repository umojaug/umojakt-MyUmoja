...
import CreditorListPDF from "./CreditorListPDF";
...
const CreditorList = () => {
  const {
    ...
    isLoading,
    isError,
  } = useGetData("AccountsCreditorListReports", "/AccountsCreditorListReports");
  ...
  return (
    <div className="card w-full max-w-screen-xl">
      <div className="flex justify-between items-center border w-40 h-8 rounded">
        <PDFDownloadLink
          document={<CreditorListPDF list={list} />}
          fileName="creditor-list.pdf"
