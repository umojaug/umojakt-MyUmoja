...
const AuditDepartmentReportList = () => {
  ...
  const {
    ...
    `/AuditBranchReportDetails/list/${id}`
  );
  ...
  return (
    <div className="card w-full max-w-screen-xl">
      <TopHeader title="Branch Audit Report Details List" />

      {data.length > 0 && (
        <div className="grid grid-cols-4 gap-1">
          <div className="">Audit Year : {list.data[0].year} </div>
          <div className="">Branch : {list.data[0].branchName}</div>
          <div className="">
      ...
      <div className="flex justify-end items-center">
        <PrintHeader
          fileName="BranchAuditReport.csv"
          data={data.map(
            ({
              year,
              reportingQuarter,
          ...
          headers={[
            ...
            { label: "Branch Response", key: "branchResponse" },
              ...
              data.map((item, i) => (
                ...
                >
                  <td className="p-2 flex justify-between space-x-2 align-top text-center">
                    {item.isComment === 0 ? (
                      <TaskButton
                        path={`/audit/reporting/branch/comments/${item.reportDetailsId}`}
                        btnColor="btn-gray"
                      />
                    ) : (
                      <TaskButton
                    ...
                    <EditButton
                      path={`/audit/reporting/branch/details/edit/${item.reportDetailsId}`}
                      btnColor="btn-gray"
                    />
                  </td>
