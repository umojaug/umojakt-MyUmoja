...
const RegionInfo = ({ id }) => {
  const {
    ...
    `/auditExcutionUnit/detailsRegion/${id}`
  );
  ...
  return (
    <>
      <div className="grid grid-cols-1 place-content-start p-3">
        ...
        <p>
          <span className="font-semibold">Name of Division: {/*  */}</span>
          {list.data.divisionName}
        </p>
        <p>
          <span className="font-semibold"> Region Start Date: {/* */}</span>
        ...
        <p>
          <span className="font-semibold">
            Region audit notification, with dates for entry and exit meetings:{" "}
            {/* */}
          </span>
