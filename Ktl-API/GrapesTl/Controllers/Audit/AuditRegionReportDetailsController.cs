...
[ApiController]
public class AuditRegionReportDetailsController(IUnitOfWork unitOfWork, IFileUploadService fileUploadService, IMailSender mailSender, ILogger<EmployeeSetupController> logger) : ControllerBase
{
    ...
    public async Task<IActionResult> List(string id)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.List<AuditRegionReportDetailsView>("AuditRegionReportDetailsGetAll", parameter);
    ...
    public async Task<IActionResult> Details(string id)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.OneRecord<AuditRegionReportDetailsView>("AuditRegionReportDetailsGetById", parameter);
    ...
    [Authorize(Roles = "Super Admin,Internal Audit Manager,Assistant Audit Manager, Internal Audit Officer")]
    [HttpPost("Update")]
    public async Task<IActionResult> Update([FromForm] AuditRegionReportDetails model)
    {
        ...
        try
        {
            ...
            parameter.Add("@RegionResponse", model.RegionResponse);
            ...
            await _unitOfWork.SP_Call.Execute("AuditRegionReportDetailsUpdate", parameter);
    ...
    public async Task<IActionResult> Delete(string id)
    {
        try
        {
            ...
            parameter.Add("@Message", "", dbType: DbType.String, direction: ParameterDirection.Output);
            await _unitOfWork.SP_Call.Execute("AuditRegionReportDetailsDelete", parameter);
