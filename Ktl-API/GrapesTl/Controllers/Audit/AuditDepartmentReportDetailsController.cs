...
[ApiController]
public class AuditDepartmentReportDetailsController(IUnitOfWork unitOfWork, IFileUploadService fileUploadService, IMailSender mailSender, ILogger<EmployeeSetupController> logger) : ControllerBase
{
    ...
    public async Task<IActionResult> List(string id)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.List<AuditDepartmentReportDetailsView>("AuditDepartmentReportDetailsGetAll", parameter);
    ...
    public async Task<IActionResult> Details(string id)
    {
        try
        {
            ...
            var data = await _unitOfWork.SP_Call.OneRecord<AuditDepartmentReportDetailsView>("AuditDepartmentReportDetailsGetById", parameter);
    ...
    [Authorize(Roles = "Super Admin,Internal Audit Manager,Assistant Audit Manager, Internal Audit Officer")]
    [HttpPost("Update")]
    public async Task<IActionResult> Update([FromForm] AuditDepartmentReportDetails model)
    {
        ...
        try
        {
            ...
            parameter.Add("@DepartmentResponse", model.DepartmentResponse);
            ...
            await _unitOfWork.SP_Call.Execute("AuditDepartmentReportDetailsUpdate", parameter);
